...
pub fn client_manager(mut stream: TcpStream, users: Arc<Mutex<ListOfUsers>>) {

    //! para JSON por mensajes, suele ser mejor leer 
    //! por líneas (con BufReader + read_line) 
    //! y deserializar cada línea, en lugar de depender
    //!  solo de buffer fijo.
    ...
    while match stream.read(&mut buffer) {
        ...
        // Ahora mismo, en client_manager.rs:13-15,
        ...
        // Lo que hace es un echo: devuelve exactamente
        // el mismo JSON que recibió.
        // 
